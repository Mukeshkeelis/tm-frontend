function navbar(theme, ownerState) {
  ...
  return {
    boxShadow: transparentNavbar || absolute ? navbarBoxShadow : navbarBoxShadow,
    backdropFilter: transparentNavbar || absolute ? "none" : `saturate(200%) blur(${pxToRem(30)})`,
    backgroundColor:
      transparentNavbar || absolute ? `${white.main} !important` : rgba(white.main, 0.8),
    ...
    top: absolute ? pxToRem(12) : pxToRem(12),
